...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine();
            // Console.WriteLine("Alına Ürün: Portakal - " + "Birim Fiyat: " + orangePrice + " - Gramaj: " + orangeGram + " - Toplam Tutar: " + orangeTotalPrice);
            // Console.WriteLine();
            ...
            //Console.WriteLine();
            //Console.WriteLine("--------------------------");
            //Console.WriteLine("Yolcu TC Kimlik No: " + passengerIdentityNumber + " - Yolcu Adı Soyad: " + passengerName + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity + " / " + passengerAge);
            ...
            //int totatPrice= shoesCount*shoesPrice+tvCount*tvPrice+computerCount*computerPrice+chairCount*chairPrice;
